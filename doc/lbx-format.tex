...
The second unknown area is the space between the last offset. For Master of Orion 2 the data always starts at 2048, the data between the last offset and 2048 seems to have no meaning.\\
